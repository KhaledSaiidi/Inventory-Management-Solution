...
export class SellComponent  implements AfterViewInit , OnDestroy{
  ...
  proceedsell(){
    ...
    console.log(this.agentProd, this.result);
    this.stockservice.sellProduct(this.agentProd, this.result).subscribe(
      response => {
        this.navigateTohome(); 
      }, error => {
            console.error(error);
